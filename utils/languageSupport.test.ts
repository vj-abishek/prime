...
for (const testCase of testCases) {
  ...
  if (passed) {
    ...
    console.log(
      `❌ Mismatch! Expected ${testCase.expected} but got ${detected}`,
    );
  }
}
...
const testLanguages: SupportedLang[] = [
  "js",
  "tsx",
  "py",
  "css",
...
for (const lang of testLanguages) {
  ...
  try {
    ...
    console.log(
      `Extension length: ${
        Array.isArray(extension) ? extension.length : "N/A"
      }`,
    );
...
console.log("\n🎉 All tests completed!");
console.log(
  "Check the console output above to verify language detection is working correctly.",
);
